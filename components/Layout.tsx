...
export const Layout: React.FC<LayoutProps> = ({ children, onSyncClick, onLogout, username }) => {
  ...
  return (
    <div className="min-h-screen flex flex-col max-w-2xl mx-auto bg-white shadow-xl relative">
      <header className="bg-white/80 backdrop-blur-md border-b border-slate-100 p-4 sticky top-0 z-[100] flex justify-between items-center">
        ...
        <div className="flex items-center gap-2">
          ...
          {/* Profile Pill - Matches Screenshot */}
          <div className="relative">
            ...
            {/* Premium Logout Dropdown */}
            {showProfileMenu && (
              <>
                <div className="fixed inset-0 z-[110]" onClick={() => setShowProfileMenu(false)} />
                <div className="absolute top-full right-0 mt-3 w-56 bg-white rounded-[2rem] shadow-[0_20px_50px_rgba(0,0,0,0.15)] border border-slate-100 p-2 animate-in fade-in zoom-in-95 slide-in-from-top-2 z-[120]">
                  ...
                  >
                    <div className="w-8 h-8 rounded-xl bg-rose-100 flex items-center justify-center group-hover:bg-rose-500 group-hover:text-white transition-colors">
